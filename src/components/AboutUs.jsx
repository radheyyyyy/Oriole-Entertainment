    ...
    <section className="about-section">
      <div className="about-container">
        <div className="about-text-column">
          ...
          <p>
            <strong>Diverse Formats & Special Events:</strong> Beyond traditional stand-up, the company is curating varied live entertainment experiences, such as Avinash Gupta’s Cassettes and CDs Nostalgia music show, the interactive Bin Bole Bol comedy game show in Gurugram, and large-scale multi-act showcases like the MAD DAWG SHOW at Delhi's Talkatora Indoor Stadium.
          </p>
        </div>
